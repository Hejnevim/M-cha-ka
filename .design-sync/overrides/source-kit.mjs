// forked from design-sync lib/source-kit.mjs — číslované složky částí IRM nejsou kategorie; skupiny řídí category v dokumentaci
...
const GENERIC_DIR = new Set(['components', 'component', 'src', 'lib', 'ui', 'packages', 'react',
  // číslované složky částí aplikace IRM — jsou to kroky sestavení, ne kategorie;
  // skupiny komponent řídí frontmatter category v .design-sync/dokumentace/
  '00-hlava', '10-styl', '20-zaklad', '30-app', '40-kalkulace', '50-zbytky',
  '60-databaze', '70-pravidla', '80-cena', '85-sestavy', '99-zaver']);
