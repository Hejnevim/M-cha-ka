...
const SLOVNIK = {
  ...
  "{r} se opravovala {n}×{duvod}. Opravit složení v databázi stojí jednou to, co nátisk stojí pokaždé.":
    { en: "{r} was corrected {n}×{duvod}. Fixing the composition in the database costs once what the proof costs every time.",
      pt: "{r} foi corrigida {n}×{duvod}. Corrigir a composição na base de dados custa uma vez o que a prova custa sempre." },
